...
public class BasePage {
	...
	public static void waitForElementTobeClickable(WebElement element, Duration timer) throws IOException {
		WebDriverWait wait = new WebDriverWait(getDriver(), timer);
		wait.until(ExpectedConditions.elementToBeClickable(element));
	}

	public static void JavascriptExecutorForElement(WebElement element) throws IOException {
